...
const GeneralServicesPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>General Services | Mimo's Collective</title>
        <meta name="description" content="Browse general services offered through Mimo's Collective." />
        <link rel="canonical" href="https://www.movsummirzazada.com/mimo-collective/general-services" />
      </Helmet>
